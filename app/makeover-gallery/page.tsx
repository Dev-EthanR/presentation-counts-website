      ...
      <div className=" mx-auto px-6">
        <div className="max-w-3xl mx-auto text-center space-y-6">
          <h2 className="text-3xl font-bold tracking-tight">
            Presentation Counts <br /> Your One Stop Property Prep Shop
          </h2>
          <p className="text-lg text-gray-300">
            We manage the entire makeover of your property using professional
            trades, ensuring a smooth process with all costs upfront.
          </p>
        </div>

        <div className="max-w-3xl mx-auto mt-12 bg-background/15 rounded-xl p-8 shadow-lg">
          <h3 className="text-2xl font-semibold mb-4">Our Common Services</h3>
